...
def qsort(uolist):
    ##print "Entered qsort with uolist = " + str(uolist)
    if len(uolist) == 0:
        return []
    elif len(uolist) == 1:
        return uolist
    ...
    for i in range(1,len(uolist)):
        ##print "uolist[i][1] > pivot[1] = " + str(uolist[i][1] > pivot[1])
        if uolist[i][1] > pivot[1]:
            list1.append(uolist[i])
        else:
            list2.append(uolist[i])
    ##print "Recursive call parameters:"
    ##print "list1 = " + str(list1)
    ##print "pivot = " + str(pivot)
    ##print "list2 = " + str(list2)
    return qsort(list1) + [pivot] + qsort(list2)
